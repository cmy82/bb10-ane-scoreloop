...
#ifndef SLUSERSCONTROLLER_H_
#define SLUSERSCONTROLLER_H_
 ...
 * @return SC_Error_t       A return code (a value of SC_OK indicates success, any other value indicates an error).
 */
//SC_PUBLISHED SC_Error_t SC_UsersController_SearchBySocialProvider(SC_UsersController_h self,
//                                                                  SC_SocialNetwork_t socialProvider);
FREObject sl_ane_SC_UsersController_SearchBySocialProvider(FREContext ctx, void* functionData,
...
//FREObject sl_ane_SC_UsersController_Cancel(FREContext ctx, void* functionData, uint32_t argc, FREObject argv[]);
